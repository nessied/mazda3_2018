...
def capture_fingerprint(params, candidate, blocked=False):
  ...
  control_keys, vehicle_keys, visual_keys, other_keys, tracking_keys = [
    ...
    "CESignal", "HideCEMStatusBar", "DeviceManagement", "IncreaseThermalLimits", "DeviceShutdown", "NoLogging", "NoUploads", "DisableOnroadUploads",
    "LowVoltageShutdown", "OfflineMode", "DrivingPersonalities", "CustomPersonalities", "TrafficPersonalityProfile", "TrafficFollow", "TrafficJerkAcceleration",
    "TrafficJerkSpeed", "AggressivePersonalityProfile", "AggressiveFollow", "AggressiveJerkAcceleration", "AggressiveJerkSpeed", "StandardPersonalityProfile",
    "StandardFollow", "StandardJerkAcceleration", "StandardJerkSpeed", "RelaxedPersonalityProfile", "RelaxedFollow", "RelaxedJerkAcceleration", "RelaxedJerkSpeed",
    "ExperimentalModeActivation", "ExperimentalModeViaLKAS", "ExperimentalModeViaTap", "ExperimentalModeViaDistance", "LateralTune", "ForceAutoTune", "NNFF",
    "NNFFLite", "SteerRatio", "TacoTune", "TurnDesires", "SteerRatio", "LongitudinalTune", "AccelerationProfile", "DecelerationProfile", "AggressiveAcceleration",
    "StoppingDistance", "LeadDetectionThreshold", "SmoothBraking", "SmoothBrakingFarLead", "SmoothBrakingJerk", "TrafficMode", "MTSCEnabled", "DisableMTSCSmoothing",
    "MTSCCurvatureCheck", "MTSCAggressiveness", "ModelSelector", "Model", "NudgelessLaneChange", "LaneChangeTime", "LaneDetectionWidth", "OneLaneChange",
    "LaneDetectionWidth", "QOLControls", "CustomCruise", "CustomCruiseLong", "MapAcceleration", "MapDeceleration", "OnroadDistanceButton", "KaofuiIcons",
    ...
    "ForceFingerprint", "DisableOpenpilotLongitudinal", "LongPitch", "GasRegenCmd", "CrosstrekTorque", "LockDoors", "StockTune", "CydiaTune",
    ...
    "AdjacentPathMetrics", "PedalsOnUI", "DynamicPedalsOnUI", "StaticPedalsOnUI", "RoadNameUI", "WheelIcon", "RotatingWheel", "CustomTheme", "CustomColors", "CustomIcons",
    "CustomSignals", "CustomSounds", "GoatScream", "HolidayThemes", "RandomEvents", "ModelUI", "DynamicPathWidth", "HideLeadMarker", "LaneLinesWidth",
    "PathEdgeWidth", "PathWidth", "RoadEdgesWidth", "UnlimitedLength", "QOLVisuals", "BigMap", "FullMap", "CameraView", "DriverCamera", "HideSpeed",
    "HideSpeedUI", "MapStyle", "NumericalTemp", "Fahrenheit", "WheelSpeed", "ScreenManagement", "HideUIElements", "HideAlerts", "HideMapIcon",
    "HideMaxSpeed", "ScreenBrightness", "ScreenBrightnessOnroad", "ScreenRecorder", "ScreenTimeout", "ScreenTimeoutOnroad", "StandbyMode",
  ], [
