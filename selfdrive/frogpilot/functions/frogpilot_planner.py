...
class FrogPilotPlanner:
  ...
  def update_v_cruise(self, carState, controlsState, enabled, modelData, v_cruise, v_ego):
    ...
    v_ego_cluster = carState.vEgoCluster if carState.vEgoCluster != 0.0 else v_ego
    ...
    return min(self.mtsc_target, max(self.overridden_speed, self.slc_target) - v_ego_diff, v_cruise)
