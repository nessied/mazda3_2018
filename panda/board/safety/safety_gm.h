...
const CanMsg GM_SDGM_TX_MSGS[] = {{0x180, 0, 4}, {0x409, 0, 7}, {0x40A, 0, 7}, {0x2CB, 0, 8}, {0x370, 0, 6},  // pt bus
...
const uint16_t GM_PARAM_HW_SDGM_LONG = 4;
...
static safety_config gm_init(uint16_t param) {
  gm_hw = GET_FLAG(param, GM_PARAM_HW_CAM) ? GM_CAM : GET_FLAG(param, GM_PARAM_HW_SDGM_LONG) ? GM_SDGM : GM_ASCM;
